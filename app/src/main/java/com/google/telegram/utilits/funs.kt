...
import com.google.telegram.database.updatePhonesToDatabase
...
fun getPlurals(count: Int) = APP_ACTIVITY.resources.getQuantityString(R.plurals.count_members, count)